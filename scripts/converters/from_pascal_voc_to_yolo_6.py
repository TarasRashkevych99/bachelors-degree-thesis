...
PATH_TO_YOLO_ANNOTATIONS = "../../3-yolo-formated-datasets/6-romanian-license-plate-dataset/dataset/annotations"
...
def convert_from_voc_to_yolo():
    ...
    for voc_annotation_full_file_name in os.listdir(PATH_TO_VOC_ANNOTATIONS):
        ...
        with open(f"{PATH_TO_VOC_ANNOTATIONS}/{voc_annotation_full_file_name}", "r") as voc_annotation_file:
            ...
            first_part = voc_annotation_full_file_name.split('.')[0]
            second_part = voc_annotation_full_file_name.split('.')[1]

            yolo_annotation_full_file_name = f"{first_part}.{second_part}.txt"
